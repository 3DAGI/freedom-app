...
9. ~~**2.4**~~ Code fertig (a Protokoll, b App; Anhänge nur verschlüsselt; zwei alte Fehler behoben), **2.5**, dann **2.2a** (Entscheidung), **2.2b**, **2.3**
