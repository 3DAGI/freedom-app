...
| 1.0 | app.ts aufteilen | in Arbeit | [#8](https://github.com/3DAGI/freedom-app/pull/8) (a), [#9](https://github.com/3DAGI/freedom-app/pull/9) (b), [#10](https://github.com/3DAGI/freedom-app/pull/10) (c), #11 (d) | a: `state.ts`, `ui.ts`; b: `tabs/kommunikation.ts`; c: `tabs/agent.ts`, `tabs/agent-netz.ts`; d: `tabs/waehrung.ts`, `tabs/earn.ts`; `app.ts` 5.816 → 5.402 → 4.419 → 2.927 → 1.763 Zeilen |
