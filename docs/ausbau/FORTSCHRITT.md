...
7. **1.2** in Arbeit (a Tresor-Baustein ✓, b Start-Dialog + Schlüssel, c weitere Geheimnisse, d Sperre/Passkey), dann **1.3**, Rest von **1.5**
...
| 1.2 | Verschlüsselter Speicher | in Arbeit | #13 (a) | a: `vault.ts` (AES-GCM 256, PBKDF2-SHA256 600.000, IndexedDB) mit 12 Tests, noch nicht verdrahtet; b–d folgen |
