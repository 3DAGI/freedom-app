...
8. ~~**3.1**~~ Code fertig (a Protokoll, b Knoten, c App; MENSCH: echte Anfrage in der Live-App), dann **3.2** in Arbeit (a Protokoll ✓, b App liest private Antworten ✓, c Knoten versiegelt sie ✓, d Sitzung und Belege, App nimmt auf private Anfragen nur noch private Antworten; MENSCH: Knoten auf ≥ 3.2c, sobald 3.2b live ist), dann **3.3**, **3.4** – private KI-Aufträge, die größte offene Datenschutzlücke (braucht kein MLS)
