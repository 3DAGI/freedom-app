...
8. ~~**3.1**~~ Code fertig (a Protokoll, b Knoten, c App; MENSCH: echte Anfrage in der Live-App), dann **3.2** in Arbeit (a Protokoll ✓, b App liest private Antworten ✓, c Knoten versiegelt sie ✓, d Knoten nimmt versiegelte Sitzung/Belege an ✓, e App schickt Sitzung/Belege versiegelt und nimmt auf private Anfragen nur noch private Antworten; MENSCH vor e: Knoten auf ≥ 3.2d), dann **3.3**, **3.4** – private KI-Aufträge, die größte offene Datenschutzlücke (braucht kein MLS)
