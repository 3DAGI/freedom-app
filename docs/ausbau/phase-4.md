...
## 4.4 Preise und Kurse – CODE FERTIG (25.09.2026, Orakel zurückgestellt)
...
## 4.6 Swaps in beide Richtungen – CODE FERTIG (26.09.2026)

> Aufgeteilt: a Protokoll ✓ (Fristregel der Gegenrichtung, Adapter, Prüfung des LP, Simulation, `docs/SWAPS.md`); b LP-Daemon Gegenrichtung ✓ (`buy-sol`, `cltv_limit` über LND, Speichern vor dem Zahlen, Nachholen nach Neustart, Blockadeschutz der Gegenrichtung); c App ✓ (Ablauf SOL → Lightning, Rückhol-Wächter verdrahtet – für Swaps und Deposits); d Vorab-Gebühr der Hinrichtung ✓ (LP + App – ändert den Ablauf Lightning → SOL, deshalb eigener Schritt); e Relayer für Nutzer ohne SOL – Protokoll + Knoten ✓ (Angebot, versiegelte Aufträge, Prüfung vor dem Mitsignieren, Dienst mit Grenze); f App ✓ (Einlösen über Relayer, Mindestmiete, nie der LP als Relayer). b allein brauchte gut 400 Zeilen Code; die Vorab-Gebühr hätte den Schritt verdoppelt.
