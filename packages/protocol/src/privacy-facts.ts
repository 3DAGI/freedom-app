...
export const PRIVACY_FACTS: readonly PrivacyFact[] = [
  ...
  { id: "nachfolge-anteile", aussage: "Die Teile deines Schlüssels für die Nachfolge gehen versiegelt an deine Vertrauten und bei der Übergabe versiegelt weiter – kein Relay sieht einen Teil.", status: "offen", schritt: "8.11b", regel: "kein-klartext" },
