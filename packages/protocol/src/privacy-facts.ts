...
export const PRIVACY_FACTS: readonly PrivacyFact[] = [
  ...
  { id: "ki-prompt", aussage: "KI-Anfragen sind für Relays nicht lesbar.", status: "offen", schritt: "3.1", regel: "kein-klartext-prompt" },
  { id: "ki-kunde", aussage: "KI-Anfragen verraten Relays nicht, wer fragt.", status: "offen", schritt: "3.1", regel: "kunde-verborgen" },
